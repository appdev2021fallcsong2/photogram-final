class LikesController < ApplicationController
  ...
  def create
    ...
    if the_like.valid?
      ...
      current_like_count = the_photo.likes_count
      the_photo.likes_count = current_like_count + 1
      the_like.save
      the_photo.save
      redirect_to("/photos/#{the_like.photo.id}", { :notice => "Like created successfully." })
    else
